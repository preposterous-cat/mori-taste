...
const products = [
  {
    ...
    tagline: 'Pure & Clean',
    description: 'Kombinasi sempurna sayuran segar pilihan — selada, kentang, jagung, wortel, dan dressing kol ungu spesial.',
    price: 'Rp 10.000',
    badge: 'Terlaris',
    accentColor: 'emerald',
    image: IMAGES.products.salad,
    ingredients: ['Selada', 'Kentang', 'Jagung', 'Wortel', 'Kol Ungu'],
  },
  {
    id: 2,
    ...
    ingredients: ['Selada', 'Kentang', 'Jagung', 'Wortel', 'Kol Ungu', 'Telur Rebus'],
  },
  {
    id: 3,
    ...
    ingredients: ['Selada', 'Kentang', 'Jagung', 'Wortel', 'Kol Ungu', 'Ayam Panggang'],
  },
];
